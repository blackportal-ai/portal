...
export const deltaRoadmap: RoadmapItem[] = [
  ...
  },
  {
    ...
    quarter: '2026 Q4',
    description:
      'Expanding Delta’s backend support with OpenCL for cross-platform GPU acceleration and Vulkan for modern, portable GPU computing, optimizing classical ML workloads.',
  },
];
...
export const nebulaRoadmap: RoadmapItem[] = [
  {
    ...
    quarter: '2025 Q2',
    description:
      'Prototypes for a CLI client to install datasets and models from a Nebula registry and a read-only registry serving assets from the filesystem.',
  },
  {
    title: 'MVP of Nebula',
    quarter: '2025 Q4',
    description:
      'Introduction of a standardized data format for datasets and models, a registry API service, and a CLI tool with functionality to search and filter available assets.',
  },
  {
    title: 'Nebula - Creator Expansion',
    quarter: '2026 Q2',
    description:
      'Enable the Nebula CLI to create new datasets and models through transfer learning or data augmentation, with functionality to share them back to the registry.',
  },
  {
    title: 'Embedded Support',
    quarter: '2026 Q4',
    description:
      'Introduce a lightweight Nebula client for embedded devices to collect training data and deploy updated models seamlessly via wired or wireless connections.',
  },
];

export const horizonRoadmap: RoadmapItem[] = [
  {
    title: 'Init title',
    quarter: '2025 Q2',
